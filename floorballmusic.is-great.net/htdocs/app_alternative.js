...
//const filenames = ['playlists.json', 'After.json', 'Intro.json', 'Lomis.json', 'Warmup.json', 'Pregame.json', 'Goal.json', 'Utvisning.json', 'Odd.json', 'Cheery.json', 'Energy.json', 'Rythm.json', 'Local.json', 'Gameevents.json', 'Hgoal.json', 'Agoal.json'];
let filenames = [];
